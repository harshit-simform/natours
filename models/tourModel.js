...
const tourSchema = new mongoose.Schema(
  {
    ...
    difficulty: {
      ...
      enum: {
        ...
        message:
          'Difficulty can only be one of the following: easy, medium, difficult',
      },
    },
    ratingsAverage: {
      type: Number,
    ...
    priceDiscount: {
      type: Number,
      validate: {
        // this will only work post request it cannot be used for put or patch because this will refer to the value of price at the time of creation, this keyword doesn't have this access at time of updating
