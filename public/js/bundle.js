...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaGFyc2hpdC1zaW1mb3JtIiwiYSI6ImNsaGdiYThxeTAybWszZXFqa2pobW9nZDcifQ.YCr6dyonilEMquYxb2sVAA';
...
var updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    var urlEndPoint, result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          urlEndPoint = type === 'password' ? 'updateMyPassword' : 'updateMe';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://localhost:3000/api/v1/users/".concat(urlEndPoint),
            data: data
          });
        case 4:
          result = _context.sent;
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourId) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          stripe = Stripe('pk_test_51N7v6eSEKt1v2oTCgXD6scSGxMsSlWcYD6ETUISUFa7xd4tLeCi2g9fplPSHZKlnLxvp0Xii76QBBoQlJ7XW5scS00rlCfD6GJ'); //1) get the session from the server
          _context.next = 4;
